          ...
          {statCards.map((stat, index) => (
            <GlassCard key={index} className="p-6 hover:scale-105 transition-all duration-300 group" data-testid={`stat-card-${index}`}>
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-black bg-white/90 px-2 py-1 rounded-md inline-block group-hover:text-primary group-hover:bg-primary/10 transition-colors" data-testid={`stat-value-${index}`}>
                  {stat.value}
                </p>
              </div>
            </GlassCard>
